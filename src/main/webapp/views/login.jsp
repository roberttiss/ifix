			...
			<c:choose>
				<c:when test="${result == 'registered'}">
					<div class="alert alert-success alert-dismissible fade show"
						role="alert">
						Customer registered successfully, please log in.
                      ...
                      <div class="card-body p-3 p-md-4 p-xl-6">
                        ...
                        <form action="../login" method="post" id="login-form">
                          <div class="row gy-2">
                            ...
                            <div class="col-12">
                              <p class="m-0 text-secondary text-center">Don't have an account?<a href="${pageContext.request.contextPath}/views/customer/createCustomer.jsp" class="link-primary text-decoration-none">Sign up</a></p>
                            </div>
                          </div>
                        </form>
                      </div>
